...
| [`google-combined`](modules/systems/gui/cursor/packages/ful1e5-cursors.nix)               | Google cursor themes with a Black hyprcursor variant                                                                               |           |
| [`google-cursor`](modules/systems/gui/cursor/packages/ful1e5-cursors.nix)                 | Opensource cursor theme inspired by Google                                                                                         |           |
| [`google-hyprcursor`](modules/systems/gui/cursor/packages/ful1e5-cursors.nix)             | GoogleDot-Black adapted for hyprcursor                                                                                             |           |
