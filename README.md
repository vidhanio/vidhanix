...
| [`delta-db`](modules/programs/delta-db/package.nix)                              | AI-native coding environment by the creators of Zed                                                                                |           |
...
| [`pi-subagents`](modules/programs/pi-coding-agent/extensions/pi-subagents.nix)   | Pi extension for single-agent delegation and scripted multi-agent workflows                                                        |     ✓     |
