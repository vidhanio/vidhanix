...
- **Writing**: always lowercase — comments, commit subjects and descriptions, CI job and step names, workflow names. Keep identifiers and `${{ }}` expressions verbatim; backtick any code reference in prose.
