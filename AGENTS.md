...
- `modules/flake/files/workflows/` — the CI workflows (`ci`, `update-packages`, `sync-action-updates`, `prune-lock`, `watch-github-refs`) and the shared `setup-nix` composite action.
